...
ds_dev_course = [['Machine Learning Crash Course by Google [Free]', 'https://developers.google.com/machine-learning/crash-course'],
...
backend_dev_course = [['Django Crash course [Free]','https://youtu.be/e1IyzVyrLSU'],
...
mobile_app_dev_course = [['Android Development for Beginners [Free]','https://youtu.be/fis26HvvDII'],
...
ios_dev_course = [['IOS App Development by LinkedIn','https://www.linkedin.com/learning/subscription/topics/ios'],
...
ui_ux_designer_course = [['Google UX Design Professional Certificate','https://www.coursera.org/professional-certificates/google-ux-design'],
